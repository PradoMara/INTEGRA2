        ...
        <main className="py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-xl">
                ...
                <div className="space-y-6">
                    <div>
                        <h2 className="text-2xl font-semibold text-blue-700 mb-3">1. Aceptación de los Términos</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-blue-700 mb-3">2. Descripción del Servicio</h2>
                        <p className="text-gray-700">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-blue-700 mb-3">3. Obligaciones del Usuario</h2>
                        <p className="text-gray-700">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-blue-700 mb-3">4. Propiedad Intelectual</h2>
                        <p className="text-gray-700">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-blue-700 mb-3">5. Política de Privacidad</h2>
                        <p className="text-gray-700">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-blue-700 mb-3">6. Limitación de Responsabilidad</h2>
                        <p className="text-gray-700">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-blue-700 mb-3">7. Modificaciones de los Términos</h2>
                        <p className="text-gray-700">
