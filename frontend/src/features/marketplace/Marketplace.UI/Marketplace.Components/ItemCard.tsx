...
// 🛑 SOLUCIÓN 1: Importar el tipo canónico Post (desde el archivo de tipos)
import type { Post } from '../../Marketplace.Types/ProductInterfaces';
// 🛑 SOLUCIÓN 2: Importar las utilidades de formato que usa el componente
import { formatCLP, formatInt } from '../../Marketplace.Utils/format'; 

// 🛑 SOLUCIÓN 3: El componente DEBE recibir el objeto 'post' completo
...
export default function ItemCard({ post }: ItemCardProps) {
  ...
  // 🛑 SOLUCIÓN 4: Desestructurar las propiedades necesarias del objeto 'post'
  const {
  ...
  // Usar 'fechaAgregado' de la API, no 'timeAgo'
 ...
 {image && (
    ...
    <div className="p-4 md:p-5">
        ...
        {/* Descripción (Cuerpo del producto) */}
        {description && (
